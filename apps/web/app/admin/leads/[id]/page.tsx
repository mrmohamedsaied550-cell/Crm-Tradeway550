        ...
        <div className="grid gap-4 lg:grid-cols-[minmax(0,1fr)_360px]">
          ...
          <div className="flex flex-col gap-4">
            ...
            <section className="rounded-lg border border-surface-border bg-surface-card p-5 shadow-card">
              ...
              {/* C30 — Scrollable timeline container */}
              <div className="max-h-[520px] overflow-y-auto scroll-smooth" style={{ scrollbarWidth: 'thin' }}>
                <ActivityTimeline
...
function QuickActionsBar({
  ...
  return (
    <div className="flex flex-wrap items-center gap-2 rounded-lg border border-surface-border bg-white p-3 shadow-sm">
      ...
      {/* C30 — WhatsApp button: opens the lead's WhatsApp conversation */}
      <a
        href={`https://wa.me/${phone.replace(/[^0-9]/g, '')}`}
        target="_blank"
        rel="noopener noreferrer"
        className="inline-flex h-9 items-center gap-1.5 rounded-md border border-surface-border bg-surface-card px-4 text-sm font-medium text-green-700 transition-colors hover:border-green-300 hover:bg-green-50 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-green-600 focus-visible:ring-offset-1"
      >
